// Otra versión del gestor de notas en donde se prueba la funcionalidad 
// de la asicronia mediante promesas y el metodo try and catch
// Ademas de probar la funcionalidad throw new Error
...
class NotesManager {
    ...
    destroy(id) {
        try {
            ...
            const whithin = NotesManager.#notes.filter((each) => each.id !== id);
            NotesManager.#notes = whithin;
...
console.log(notes.read()); // sin try catch se termino la ejecucion cuando ocurrio este error
